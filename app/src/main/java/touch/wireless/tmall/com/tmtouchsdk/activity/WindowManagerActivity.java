...
public class WindowManagerActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        final WindowManager windowManager = (WindowManager) this.getApplication().getSystemService(Context.WINDOW_SERVICE);
        ...
        final TextView view = (TextView) LayoutInflater.from(this).inflate(R.layout.data_item_test, null);
